...
const seed = [
  ...
  },
  {
    id: "n2",
    adapter: "slack",
    source: "FWD GROUP MANAGEMENT HOLDINGS LIMITED",
    title: "Steve Cao in #eliteguru-prs",
    body: "Steve Cao: Hi @Lionel Andrieu, @Luke Pham I've created a pull request 146128: chore: sync dev to uat and resolve conflicts https://dev.azure.com/FWDGODevOps/FWD_Cube_Frontend/_git/repo/pullrequest/146128",
    targetId: "t-slack",
    targetUrl: "https://app.slack.com/client/T123/C1",
    groupKey: "slack:T123",
    channelId: "C1",
    slackKind: "channel",
    slackConvo: "eliteguru-prs",
    slackMention: true,
  ...
  },
  {
    ...
    source: "FWD Group",
    title: "Careen Tan",
    body: "Careen Tan: can you review the deploy doc?",
    targetId: "t-slack",
    targetUrl: "https://app.slack.com/client/T9/D1",
    groupKey: "slack:T9",
    channelId: "D1",
    slackKind: "im",
    slackConvo: "Careen Tan",
    slackMention: false,
