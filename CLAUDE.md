...
└── src/
    ...
    │   ├── input-coalesce.ts  # Web build: generic command batcher (coalesce moves / accumulate wheel / flush discrete)
    │   └── utils.ts           # cn() utility
