...
const ADAPTERS = [
  {
    ...
    // Teams also drives the standalone chat app (t105, ADR-0018): the side-channel dumps the
    // MSAL bearer + authz-mints a skype token IN-PAGE for the messaging API. Web build only —
