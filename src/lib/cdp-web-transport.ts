...
import { noteFrameAge } from "./latency-metrics"
...
export type Cmd = { method: string; params?: unknown }
...
export function createWebCdp(deps: WebTransportDeps = resolveDeps()): CdpBridge {
  ...
  return {
    ...
    onSwipe: () => () => {}, // no trackpad swipe over the web — no-op subscribe + unsubscribe
